...
<head>
    ...
    <title>BlueWave Safaris - Tour Guide Dashboard</title>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                ...
                <a href="index.jsp" class="text-2xl font-extrabold tracking-wide whitespace-nowrap hover:text-blue-400 transition">
            ...
            <div class="flex items-center space-x-6">
                ...
                <a href="/tour-guide/profile" class="text-xl hover:text-blue-400 transition transform hover:scale-110" aria-label="Profile">
...
<header class="pt-28">
    <div class="max-w-7xl mx-auto px-6 text-left" data-aos="fade-right" data-aos-duration="1000">
        <h1 class="text-5xl font-extrabold text-gray-800 mb-3">🛳 Your Assigned Trips</h1>
        <p class="text-lg text-gray-600">Manage feedbacks for trips assigned to you.</p>
    </div>
</header>
...
<section class="max-w-7xl mx-auto px-6 py-12 flex-grow">
    <c:if test="${empty trips}">
        <p class="text-center text-gray-500 text-lg" data-aos="fade-up">🚫 No trips assigned at the moment. Please check back later.</p>
    </c:if>
        ...
        <c:forEach var="trip" items="${trips}">
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 overflow-hidden"
                ...
                <div class="p-6">
                    ...
                    <!-- Action Buttons (Feedback Management) -->
                    <div class="mt-5 flex flex-col gap-3">
                        <a href="/tour-guide/add-feedbacks?tripId=${trip.id}"
                           class="w-full block text-center bg-green-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-green-600 transform hover:scale-105 transition">
                            <i class="fas fa-comment"></i> Add Feedbacks
                        </a>
                        <a href="/tour-guide/edit-feedbacks?tripId=${trip.id}"
                           class="w-full block text-center bg-yellow-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-yellow-600 transform hover:scale-105 transition">
                            <i class="fas fa-edit"></i> Edit Feedbacks
                        </a>
                    </div>
                </div>
            </div>
