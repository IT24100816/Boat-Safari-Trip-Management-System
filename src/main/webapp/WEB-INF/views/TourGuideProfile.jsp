...
<head>
  ...
  <title>Tour Guide Profile - BlueWave Safaris</title>
...
<nav class="bg-black text-white fixed w-full z-50 shadow-lg">
    ...
    <div class="flex items-center justify-between h-24">
      <div class="flex items-center space-x-3 flex-shrink-0">
        ...
        <div class="text-3xl font-extrabold tracking-wide">
          <span class="text-blue-400">BlueWave</span> Safaris - Tour Guide
        </div>
      </div>
      <div class="hidden lg:flex items-center space-x-8 font-semibold text-lg">
        <a href="/tour-guide/dashboard" class="hover:text-blue-400 transition">Dashboard</a>
        <a href="/tour-guide/profile" class="hover:text-blue-400 transition">
  ...
  <div id="mobile-menu" class="hidden lg:hidden bg-black px-6 py-4 space-y-4 text-lg">
    <a href="/tour-guide/dashboard" class="block hover:text-blue-400 transition">Dashboard</a>
    <a href="/tour-guide/profile" class="block hover:text-blue-400 transition">
      <i class="fas fa-user mr-2"></i> Profile
    </a>
    <a href="/logout" class="block hover:text-blue-400 transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
      ...
      <div class="relative bg-gradient-to-b from-blue-50 to-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300 border border-gray-200">
        ...
        <div class="relative flex flex-col items-center text-center pt-20 pb-8 px-6">
          ...
          <h3 class="text-2xl font-bold text-gray-800 mt-4">${tourGuide.firstName} ${tourGuide.lastName}</h3>
          <p class="text-gray-500 text-sm mt-1">${tourGuide.email}</p>
          <span class="mt-2 px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs font-medium shadow-sm uppercase tracking-wide">
            ${tourGuide.role != null ? tourGuide.role : "Tour Guide"}
          </span>
          ...
          <div class="space-y-3 text-sm text-left w-full px-3">
            <p class="flex items-center">
              ...
              <span><strong>NIC:</strong> ${tourGuide.nic}</span>
            </p>
            <p class="flex items-center">
              <i class="fas fa-birthday-cake text-blue-500 mr-3"></i>
              <span><strong>Age:</strong> ${tourGuide.age}</span>
            </p>
            <p class="flex items-center">
              <i class="fas fa-phone text-blue-500 mr-3"></i>
              <span><strong>Phone:</strong> ${tourGuide.phone}</span>
            </p>
            <p class="flex items-center">
              <i class="fas fa-language text-blue-500 mr-3"></i>
              <span><strong>Language:</strong> ${tourGuide.language}</span>
            </p>
          </div>
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div id="edit" class="bg-white rounded-2xl shadow-xl p-8 card">
          ...
          <form action="/tour-guide/profile/edit" method="post" onsubmit="return validateForm()" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" id="firstName" name="firstName" value="${tourGuide.firstName}"
              ...
              <div>
                ...
                <input type="text" id="lastName" name="lastName" value="${tourGuide.lastName}"
                       class="w-full p-3 border border-gray-200 rounded focus-ring" required />
              </div>
              <div>
                <label for="email" class="block text-sm font-medium text-gray-600 mb-1">Email</label>
                <input type="email" id="email" name="email" value="${tourGuide.email}"
              ...
              <div>
                ...
                <input type="text" id="nic" name="nic" value="${tourGuide.nic}"
                       class="w-full p-3 border border-gray-200 rounded focus-ring" required />
              </div>
              <div>
                <label for="age" class="block text-sm font-medium text-gray-600 mb-1">Age</label>
                <input type="number" id="age" name="age" value="${tourGuide.age}"
              ...
              <div>
                <label for="language" class="block text-sm font-medium text-gray-600 mb-1">Language</label>
                <input type="text" id="language" name="language" value="${tourGuide.language}"
                       class="w-full p-3 border border-gray-200 rounded focus-ring" required />
              </div>
            </div>
        ...
        <div id="passwordForm" class="bg-white rounded-2xl shadow-xl p-8 card hidden">
          ...
          <form action="/tour-guide/profile/change-password" method="post" onsubmit="return validatePasswordChange()" class="space-y-6">
            <input type="hidden" name="id" value="${tourGuide.id}" />
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 card border border-red-200">
          ...
          <form id="deleteForm" action="/tour-guide/profile/delete" method="post" onsubmit="return validateDelete()" class="mt-6 space-y-4 hidden">
            <input type="hidden" name="id" value="${tourGuide.id}" />
            <div>
